...
# From my perspective, observations are the single figure or case that we are
# trying to collect about a given variable. 
# The term "variables" are also known as columns in statistics. Variables could be 
# anything like the attributes, characteristics, or properties that can be measured.
# Each variable could be used to collect many different types of data. 
# In conclusion, observations and variables are closely linked and has a strong
# relationship. Mostly, each row represents observations and each column represents
# variables. Each observation records values for all the variables.
# 
